...
router.get("/GetAllProduct", userMiddleware_1.default, userShoping_1.default.getAllProduct);
...
router.post("/Wishlist", userMiddleware_1.default, userShoping_1.default.addToWishlist);
